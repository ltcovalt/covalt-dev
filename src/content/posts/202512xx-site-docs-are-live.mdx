...
updated: 2025-12-31
draft: true
tags: [blog, docs, documentation, api, astro]
---
...
technical implementation right now, but I'll briefly discuss some of the
highlights and major issues.
...
<Alert>
	Note that you don't have to use Typescript or TSDoc. TypeDoc will happily
	generate documentation from well-formatted JSDoc comments.
</Alert>
...
[/docs/servicenow/check/typedoc/README.md](/docs/servicenow/check/typedoc/README.md).
...
made things more difficult on myself in someways, but I think the end result was
worth it. I'll continue to refine and the solution and make smaller enhancements
over time, but now that I have a working solution in place, I'm going to shift
my focus back to building and sharing new solutions. Be sure to keep an eye on
the [docs site](https://covalt.dev/docs) if your interested.
