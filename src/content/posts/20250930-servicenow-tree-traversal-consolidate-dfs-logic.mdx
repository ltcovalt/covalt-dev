...
I'm not sure this is the exact solution I'll stick with, but this should give
...
<Alert type="warning">
	...
	convention. You will sometimes encounter JavaScript methods that are
	actually public, even though the name starts with an underscore. In the
	script example above, `_traverseDfs` is truly private because it is defined
	within our IIFE, and we prefix with an underscore simply to convey intent to
	future devs reading the code.
</Alert>
