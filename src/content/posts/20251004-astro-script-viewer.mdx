...
[https://covalt.dev/docs/servicenow/server/record-tree](/code/servicenow/tree).

<Alert>
	The link above originally pointed to `/code/servicenow/tree` but has since
	been updated to point to `/docs`.
</Alert>
