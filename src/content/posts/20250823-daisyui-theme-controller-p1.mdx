...
with broken into subcomponents. My final component structure is below.
...
<Alert type="warning">
  While the above works, it would have been much simpler to get the colors from the relevant
  `data-theme` attribute. I'm leaving it as is so others can learn from my folly :)
</Alert>
