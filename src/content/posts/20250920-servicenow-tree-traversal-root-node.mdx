...
description:
    Creating a Tree traversal script include namespace in ServiceNow and
    functions to traverse to the root node of a tree
author: 'Luke Covalt'
date: 2025-09-20
updated: 2025-09-21
draft: false
...
<Alert type="info">
    ...
    View the complete code: [Tree.js](/docs/servicenow/server/record-tree)
...
<Alert type="note">
	...
	[Tree.js](/docs/servicenow/server/record-tree)
</Alert>
