...
| ------ | ------ |
| [detail](functions/detail.md) | Performs a typeof check on a value and retrieves additional contextual information based on the type being checked. Examples, number (NaN), number (Integer), object (GlideRecord) |
