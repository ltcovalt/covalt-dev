...
const RecordTree = {
	 ...
	 * @returns {GlideRecord} the root node of the tree
	 */
	traverseToRoot({ node, parentField = 'parent', stackPath = [] }, callback) {
		...
		return RecordTree.traverseToRoot({ node: parentNode, parentField, stackPath }, callback);
	},
	 ...
	 * @param {array} [params.stackPath=[]] - array of node sys_ids representing the current path of nodes already visited
	 */
	traversePreOrder(params, callback) {
		return RecordTree.traverseDfs({ ...params, callback, preOrder: true });
	},
	 ...
	 * @param {array} [params.stackPath=[]] - array of node sys_ids representing the current path of nodes already visited
	 */
	traversePostOrder(params, callback) {
		return RecordTree.traverseDfs({ ...params, callback, postOrder: true });
	},
};
